...
router.post('/scanbarcode', authentication.shallPass ,function(req, res, next){////Barcode Search
  ...
  Brand.find({})
    ...
    .then(function(brands) {
      ...
      brands.forEach(function(value) {
        prom.push(
          Product.findOne(
            { brand: value.brandName, $text: { $search: req.body.q } },
...
router.post('/analyzeVideo', authentication.shallPass ,function(req,res,next){
  req.api=true;
